 ...
 * speedy is 2 times faster than others
 */
public class Speedy extends Enemy{
    ...
    private Image image = Gfx.Speedy.getImage();
    private Image imageDeath = Gfx.SpeedyDeath.getImage();
     ...
     * @param string
     */
    public Speedy(int positionX, int positionY, String note) {
    ...
    /**
     * this method read String data and convert them into new Speedy
     * Used for loading game and server comunication
     * @param stringEnemy string data of Speedy
     * @return new instance of Speedy
     */
    static public Speedy readFromString(String stringEnemy){
